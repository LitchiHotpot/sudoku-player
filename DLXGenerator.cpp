...
vector<ColumnHead*> DLXGenerator::
createColumnHeads(DLXNode* listHead, int length) {
...
void DLXGenerator:: appendLine(vector<ColumnHead*>
 columnHeads, vector<int> elementSubscripts, int rowIndex) {
